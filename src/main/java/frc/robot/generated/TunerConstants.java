...
// import frc.robot.subsystems.CommandSwerveDrivetrain;         // AdvantageKit says comment out
...
public class TunerConstants {
  ...
  private static final Slot0Configs steerGains =
      new Slot0Configs()
          ...
          .withKS(0)
          .withKV(0)
          .withKA(0) // original values: .withKS(0.2).withKV(2.33).withKA(0)
  ...
  private static final double kSteerInertia = 0.004; // AdvantageKit constant
  private static final double kDriveInertia = 0.025; // AdvantageKit constant
